...
class SafetyBoundaries: ObservableObject {
    ...
    private let clinicalKeywords = [clinical trial", "clinical study", "medical research", "drug development",
    ...
    private let dangerousPatterns = [private let dangerousPatterns = [
